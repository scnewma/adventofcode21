...
mod tests {
    ...
    #[test]
    fn test_part01() {
        assert_eq!(45, part01(include_str!("../inputs/17.test.txt")));
        assert_eq!(9180, part01(include_str!("../inputs/17.txt")));
    }

    #[test]
    fn test_part02() {
        assert_eq!(112, part02(include_str!("../inputs/17.test.txt")));
        assert_eq!(3767, part02(include_str!("../inputs/17.txt")));
    }
}
